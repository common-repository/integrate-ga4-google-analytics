...
Tags: analytics, ga4, google analytics plugin, tracking, integrate ga4 google analytics
Tested up to: 6.5.4
Stable tag: 1.3.2
...
To disable tracking for User roles, select the roles you wish to disable. Press the "Save Changes" button.
...
* Make the plugin translation ready by using the __() and _e() functions for all text strings. 06/02/2024
* Update validation callback signature: The validate_callback iga_validate_gtag_id now accepts the input value and an array of additional arguments. 06/01/2024
* Add feature to disable tracking for user roles. 05/23/2024
* Add asynchronous loading of GA4 Script to improve page load performance. 05/17/2024
